...
const CHURCHTOOLS_URL = requireEnv(import.meta.env.VITE_CHURCHTOOLS_URL, 'VITE_CHURCHTOOLS_URL');
const CHURCHTOOLS_CLIENT_ID = requireEnv(import.meta.env.VITE_CHURCHTOOLS_CLIENT_ID, 'VITE_CHURCHTOOLS_CLIENT_ID');
